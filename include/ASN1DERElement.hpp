...
public:
  ...
  enum Primitive { Primitive = 0, Contructed = 1 };
  ...
  public:
    ASN1DERElementIterator(const ASN1TAG *buf, size_t containerSize,
                           uint64_t pos);
...
private:
  ...
  /*
      ...
      if we construct an object ourselve we alloc a buffer and thus claim
     ownership
   */
  bool _ownsBuffer;
